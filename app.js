var pTurn, moves, isGameOver, span, restartButton;
...
function gameOver(a) {
    var gameOverAlertElement = "<b><br>GAME OVER </b><br><br> Player " + span[a].dataset.player.toUpperCase() + ' Win !!! <br><br>' + restartButton;
